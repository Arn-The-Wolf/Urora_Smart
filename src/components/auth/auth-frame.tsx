...
export function AuthFrame({
  ...
  subtitle: string;
  children: ReactNode;
  /** Omit on login (entry). Register uses /login. */
  backHref?: string;
}) {
  return (
    <div className="relative flex min-h-full items-center justify-center bg-[#f4f7f1] px-5 py-10">
      ...
      <div className="w-full max-w-[410px] rounded-[20px] bg-white p-8 shadow-[0_25px_70px_#173d3140] animate-fade-up">
        <UroraMark />
        <p className="mt-6 text-[10px] font-bold tracking-[1.5px] text-[#7a9184]">SPRING FARMS</p>
